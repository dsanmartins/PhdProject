 ...
 *   <li>{@link br.ufscar.sas.xtext.sasdsl.sasDsl.impl.DSLRuleExecutorImpl#getMonitor <em>Monitor</em>}</li>
 *   <li>{@link br.ufscar.sas.xtext.sasdsl.sasDsl.impl.DSLRuleExecutorImpl#getAnalyzer <em>Analyzer</em>}</li>
...
public class DSLRuleExecutorImpl extends DSLRulesImpl implements DSLRuleExecutor
{
  ...
  public DSLMonitor getMonitor()
  {
    if (monitor != null && monitor.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SasDslPackage.DSL_RULE_EXECUTOR__MONITOR, oldMonitor, monitor));
      }
    }
    return monitor;
  }
  ...
  public void setMonitor(DSLMonitor newMonitor)
  {
    ...
    monitor = newMonitor;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SasDslPackage.DSL_RULE_EXECUTOR__MONITOR, oldMonitor, monitor));
  }
  ...
  public DSLAnalyzer getAnalyzer()
  {
    if (analyzer != null && analyzer.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SasDslPackage.DSL_RULE_EXECUTOR__ANALYZER, oldAnalyzer, analyzer));
      }
    }
    return analyzer;
  }
  ...
  public void setAnalyzer(DSLAnalyzer newAnalyzer)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SasDslPackage.DSL_RULE_EXECUTOR__ANALYZER, oldAnalyzer, analyzer));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case SasDslPackage.DSL_RULE_EXECUTOR__MONITOR:
        if (resolve) return getMonitor();
        return basicGetMonitor();
      case SasDslPackage.DSL_RULE_EXECUTOR__ANALYZER:
