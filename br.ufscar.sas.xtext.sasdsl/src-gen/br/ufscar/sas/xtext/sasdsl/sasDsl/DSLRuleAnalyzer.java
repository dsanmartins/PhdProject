 ...
 *   <li>{@link br.ufscar.sas.xtext.sasdsl.sasDsl.DSLRuleAnalyzer#getExecutor <em>Executor</em>}</li>
...
public interface DSLRuleAnalyzer extends DSLRules
{
   ...
   * @see br.ufscar.sas.xtext.sasdsl.sasDsl.SasDslPackage#getDSLRuleAnalyzer_Executor()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link br.ufscar.sas.xtext.sasdsl.sasDsl.DSLRuleAnalyzer#getExecutor <em>Executor</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
