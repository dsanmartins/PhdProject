 ...
 *   <li>{@link br.ufscar.sas.xtext.sasdsl.sasDsl.impl.DSLMeasuredOutputImpl#getLayer <em>Layer</em>}</li>
 *   <li>{@link br.ufscar.sas.xtext.sasdsl.sasDsl.impl.DSLMeasuredOutputImpl#getSubSystem <em>Sub System</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DSLMeasuredOutputImpl extends MinimalEObjectImpl.Container implements DSLMeasuredOutput
{
  ...
  public DCLStructureElement getLayer()
  {
    if (layer != null && layer.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SasDslPackage.DSL_MEASURED_OUTPUT__LAYER, oldLayer, layer));
      }
    }
    return layer;
  }
  ...
  public void setLayer(DCLStructureElement newLayer)
  {
    ...
    layer = newLayer;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SasDslPackage.DSL_MEASURED_OUTPUT__LAYER, oldLayer, layer));
  }
  ...
  public DCLStructureElement getSubSystem()
  {
    if (subSystem != null && subSystem.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SasDslPackage.DSL_MEASURED_OUTPUT__SUB_SYSTEM, oldSubSystem, subSystem));
      }
    }
    return subSystem;
  }
  ...
  public void setSubSystem(DCLStructureElement newSubSystem)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SasDslPackage.DSL_MEASURED_OUTPUT__SUB_SYSTEM, oldSubSystem, subSystem));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SasDslPackage.DSL_MEASURED_OUTPUT__NAME:
        return getName();
      case SasDslPackage.DSL_MEASURED_OUTPUT__LAYER:
        if (resolve) return getLayer();
        return basicGetLayer();
      case SasDslPackage.DSL_MEASURED_OUTPUT__SUB_SYSTEM:
