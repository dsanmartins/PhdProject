...
public class SasDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SasDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDSLRuleControllerAccess().getAlternatives(), "rule__DSLRuleController__Alternatives");
			...
			builder.put(grammarAccess.getDSLRuleControllerAccess().getGroup_0(), "rule__DSLRuleController__Group_0__0");
			builder.put(grammarAccess.getDSLRuleControllerAccess().getGroup_1(), "rule__DSLRuleController__Group_1__0");
			builder.put(grammarAccess.getDSLRuleControllerAccess().getGroup_2(), "rule__DSLRuleController__Group_2__0");
			builder.put(grammarAccess.getDSLRuleControllerAccess().getGroup_3(), "rule__DSLRuleController__Group_3__0");
			...
			builder.put(grammarAccess.getDSLRuleControllerAccess().getControllerAssignment_0_1(), "rule__DSLRuleController__ControllerAssignment_0_1");
			builder.put(grammarAccess.getDSLRuleControllerAccess().getAccessAssignment_0_2(), "rule__DSLRuleController__AccessAssignment_0_2");
			builder.put(grammarAccess.getDSLRuleControllerAccess().getMonitorAssignment_0_4(), "rule__DSLRuleController__MonitorAssignment_0_4");
			builder.put(grammarAccess.getDSLRuleControllerAccess().getControllerAssignment_1_1(), "rule__DSLRuleController__ControllerAssignment_1_1");
			builder.put(grammarAccess.getDSLRuleControllerAccess().getAccessAssignment_1_2(), "rule__DSLRuleController__AccessAssignment_1_2");
			builder.put(grammarAccess.getDSLRuleControllerAccess().getAnalyzerAssignment_1_4(), "rule__DSLRuleController__AnalyzerAssignment_1_4");
			builder.put(grammarAccess.getDSLRuleControllerAccess().getControllerAssignment_2_1(), "rule__DSLRuleController__ControllerAssignment_2_1");
			builder.put(grammarAccess.getDSLRuleControllerAccess().getAccessAssignment_2_2(), "rule__DSLRuleController__AccessAssignment_2_2");
			builder.put(grammarAccess.getDSLRuleControllerAccess().getPlannerAssignment_2_4(), "rule__DSLRuleController__PlannerAssignment_2_4");
			builder.put(grammarAccess.getDSLRuleControllerAccess().getControllerAssignment_3_1(), "rule__DSLRuleController__ControllerAssignment_3_1");
			builder.put(grammarAccess.getDSLRuleControllerAccess().getAccessAssignment_3_2(), "rule__DSLRuleController__AccessAssignment_3_2");
			builder.put(grammarAccess.getDSLRuleControllerAccess().getExecutorAssignment_3_4(), "rule__DSLRuleController__ExecutorAssignment_3_4");
