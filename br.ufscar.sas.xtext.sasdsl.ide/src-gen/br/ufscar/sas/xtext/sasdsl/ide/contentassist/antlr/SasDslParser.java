...
public class SasDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SasDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDSLRuleMonitorAccess().getAccessAlternatives_4_2_0(), "rule__DSLRuleMonitor__AccessAlternatives_4_2_0");
			builder.put(grammarAccess.getDSLRuleMonitorAccess().getAccessAlternatives_5_2_0(), "rule__DSLRuleMonitor__AccessAlternatives_5_2_0");
			...
			builder.put(grammarAccess.getDSLRulePlannerAccess().getAccessAlternatives_5_2_0(), "rule__DSLRulePlanner__AccessAlternatives_5_2_0");
			...
			builder.put(grammarAccess.getDSLRuleExecutorAccess().getAccessAlternatives_4_2_0(), "rule__DSLRuleExecutor__AccessAlternatives_4_2_0");
			builder.put(grammarAccess.getDSLRuleExecutorAccess().getAccessAlternatives_5_2_0(), "rule__DSLRuleExecutor__AccessAlternatives_5_2_0");
			builder.put(grammarAccess.getDSLRuleKnowledgeAccess().getAlternatives(), "rule__DSLRuleKnowledge__Alternatives");
			builder.put(grammarAccess.getDSLRuleKnowledgeAccess().getAccessAlternatives_0_2_0(), "rule__DSLRuleKnowledge__AccessAlternatives_0_2_0");
			builder.put(grammarAccess.getDSLRuleKnowledgeAccess().getAccessAlternatives_1_2_0(), "rule__DSLRuleKnowledge__AccessAlternatives_1_2_0");
			...
			builder.put(grammarAccess.getDSLMeasuredOutputAccess().getAlternatives_2(), "rule__DSLMeasuredOutput__Alternatives_2");
			builder.put(grammarAccess.getDCLStructureElementAccess().getAlternatives(), "rule__DCLStructureElement__Alternatives");
			builder.put(grammarAccess.getDCLLayerAccess().getAlternatives_5(), "rule__DCLLayer__Alternatives_5");
			builder.put(grammarAccess.getDCLComponentAccess().getAlternatives_2(), "rule__DCLComponent__Alternatives_2");
			builder.put(grammarAccess.getInterfaceTypeAccess().getInterfaceTypeNameAlternatives_0(), "rule__InterfaceType__InterfaceTypeNameAlternatives_0");
			builder.put(grammarAccess.getDCDeclAccess().getAlternatives(), "rule__DCDecl__Alternatives");
			...
			builder.put(grammarAccess.getDSLRuleMonitorAccess().getGroup_4(), "rule__DSLRuleMonitor__Group_4__0");
			builder.put(grammarAccess.getDSLRuleMonitorAccess().getGroup_5(), "rule__DSLRuleMonitor__Group_5__0");
			...
			builder.put(grammarAccess.getDSLRulePlannerAccess().getGroup_5(), "rule__DSLRulePlanner__Group_5__0");
			...
			builder.put(grammarAccess.getDSLRuleExecutorAccess().getGroup_4(), "rule__DSLRuleExecutor__Group_4__0");
			builder.put(grammarAccess.getDSLRuleExecutorAccess().getGroup_5(), "rule__DSLRuleExecutor__Group_5__0");
			builder.put(grammarAccess.getDSLRuleKnowledgeAccess().getGroup_0(), "rule__DSLRuleKnowledge__Group_0__0");
			builder.put(grammarAccess.getDSLRuleKnowledgeAccess().getGroup_1(), "rule__DSLRuleKnowledge__Group_1__0");
			...
			builder.put(grammarAccess.getDSLSensorAccess().getGroup_2_0(), "rule__DSLSensor__Group_2_0__0");
			builder.put(grammarAccess.getDSLSensorAccess().getGroup_2_1(), "rule__DSLSensor__Group_2_1__0");
			builder.put(grammarAccess.getDSLEffectorAccess().getGroup(), "rule__DSLEffector__Group__0");
			builder.put(grammarAccess.getDSLEffectorAccess().getGroup_2_0(), "rule__DSLEffector__Group_2_0__0");
			builder.put(grammarAccess.getDSLEffectorAccess().getGroup_2_1(), "rule__DSLEffector__Group_2_1__0");
			...
			builder.put(grammarAccess.getDSLMeasuredOutputAccess().getGroup_2_0(), "rule__DSLMeasuredOutput__Group_2_0__0");
			builder.put(grammarAccess.getDSLMeasuredOutputAccess().getGroup_2_1(), "rule__DSLMeasuredOutput__Group_2_1__0");
			builder.put(grammarAccess.getDSLAlternativeAccess().getGroup(), "rule__DSLAlternative__Group__0");
			builder.put(grammarAccess.getDCLLayerAccess().getGroup(), "rule__DCLLayer__Group__0");
			builder.put(grammarAccess.getDCLLayerAccess().getGroup_5_0(), "rule__DCLLayer__Group_5_0__0");
			builder.put(grammarAccess.getDCLLayerAccess().getGroup_5_1(), "rule__DCLLayer__Group_5_1__0");
			builder.put(grammarAccess.getDCLLayerAccess().getGroup_5_2(), "rule__DCLLayer__Group_5_2__0");
			builder.put(grammarAccess.getDCLComponentAccess().getGroup(), "rule__DCLComponent__Group__0");
			builder.put(grammarAccess.getDCLComponentAccess().getGroup_2_0(), "rule__DCLComponent__Group_2_0__0");
			builder.put(grammarAccess.getDCLComponentAccess().getGroup_2_1(), "rule__DCLComponent__Group_2_1__0");
			builder.put(grammarAccess.getDCLComponentInterfaceAccess().getGroup(), "rule__DCLComponentInterface__Group__0");
			builder.put(grammarAccess.getDCLComponentInterfaceAccess().getGroup_4(), "rule__DCLComponentInterface__Group_4__0");
			builder.put(grammarAccess.getDCLSubSystemAccess().getGroup(), "rule__DCLSubSystem__Group__0");
			builder.put(grammarAccess.getDCLSubSystemAccess().getGroup_2(), "rule__DCLSubSystem__Group_2__0");
			builder.put(grammarAccess.getDCLModuleAccess().getGroup(), "rule__DCLModule__Group__0");
			builder.put(grammarAccess.getDCDeclAccess().getGroup_0(), "rule__DCDecl__Group_0__0");
			builder.put(grammarAccess.getDCDeclAccess().getGroup_1(), "rule__DCDecl__Group_1__0");
			builder.put(grammarAccess.getDCDeclAccess().getGroup_2(), "rule__DCDecl__Group_2__0");
			builder.put(grammarAccess.getDCDeclAccess().getGroup_3(), "rule__DCDecl__Group_3__0");
			builder.put(grammarAccess.getDCDeclAccess().getGroup_4(), "rule__DCDecl__Group_4__0");
			...
			builder.put(grammarAccess.getArchitectureDefinitionAccess().getDCDeclAssignment_9(), "rule__ArchitectureDefinition__DCDeclAssignment_9");
			...
			builder.put(grammarAccess.getDSLRuleMonitorAccess().getMonitor2Assignment_0_4(), "rule__DSLRuleMonitor__Monitor2Assignment_0_4");
			...
			builder.put(grammarAccess.getDSLRuleMonitorAccess().getAnalyzerAssignment_1_4(), "rule__DSLRuleMonitor__AnalyzerAssignment_1_4");
			...
			builder.put(grammarAccess.getDSLRuleMonitorAccess().getPlannerAssignment_2_4(), "rule__DSLRuleMonitor__PlannerAssignment_2_4");
			...
			builder.put(grammarAccess.getDSLRuleMonitorAccess().getExecutorAssignment_3_4(), "rule__DSLRuleMonitor__ExecutorAssignment_3_4");
			builder.put(grammarAccess.getDSLRuleMonitorAccess().getMonitorAssignment_4_1(), "rule__DSLRuleMonitor__MonitorAssignment_4_1");
			builder.put(grammarAccess.getDSLRuleMonitorAccess().getAccessAssignment_4_2(), "rule__DSLRuleMonitor__AccessAssignment_4_2");
			builder.put(grammarAccess.getDSLRuleMonitorAccess().getKnowledgeAssignment_4_4(), "rule__DSLRuleMonitor__KnowledgeAssignment_4_4");
			builder.put(grammarAccess.getDSLRuleMonitorAccess().getMonitorAssignment_5_1(), "rule__DSLRuleMonitor__MonitorAssignment_5_1");
			builder.put(grammarAccess.getDSLRuleMonitorAccess().getAccessAssignment_5_2(), "rule__DSLRuleMonitor__AccessAssignment_5_2");
			builder.put(grammarAccess.getDSLRuleMonitorAccess().getSensorAssignment_5_4(), "rule__DSLRuleMonitor__SensorAssignment_5_4");
			...
			builder.put(grammarAccess.getDSLRuleAnalyzerAccess().getMonitorAssignment_0_4(), "rule__DSLRuleAnalyzer__MonitorAssignment_0_4");
			...
			builder.put(grammarAccess.getDSLRuleAnalyzerAccess().getAnalyzer2Assignment_1_4(), "rule__DSLRuleAnalyzer__Analyzer2Assignment_1_4");
			...
			builder.put(grammarAccess.getDSLRuleAnalyzerAccess().getExecutorAssignment_3_4(), "rule__DSLRuleAnalyzer__ExecutorAssignment_3_4");
			...
			builder.put(grammarAccess.getDSLRuleAnalyzerAccess().getKnowledgeAssignment_4_4(), "rule__DSLRuleAnalyzer__KnowledgeAssignment_4_4");
			...
			builder.put(grammarAccess.getDSLRuleAnalyzerAccess().getRreferenceAssignment_5_4(), "rule__DSLRuleAnalyzer__RreferenceAssignment_5_4");
			...
			builder.put(grammarAccess.getDSLRuleAnalyzerAccess().getShaltAssignment_6_4(), "rule__DSLRuleAnalyzer__ShaltAssignment_6_4");
			...
			builder.put(grammarAccess.getDSLRulePlannerAccess().getMonitorAssignment_0_4(), "rule__DSLRulePlanner__MonitorAssignment_0_4");
			...
			builder.put(grammarAccess.getDSLRulePlannerAccess().getPlanner2Assignment_2_4(), "rule__DSLRulePlanner__Planner2Assignment_2_4");
			...
			builder.put(grammarAccess.getDSLRulePlannerAccess().getExecutorAssignment_3_4(), "rule__DSLRulePlanner__ExecutorAssignment_3_4");
			...
			builder.put(grammarAccess.getDSLRulePlannerAccess().getKnowledgeAssignment_4_4(), "rule__DSLRulePlanner__KnowledgeAssignment_4_4");
			builder.put(grammarAccess.getDSLRulePlannerAccess().getPlannerAssignment_5_1(), "rule__DSLRulePlanner__PlannerAssignment_5_1");
			builder.put(grammarAccess.getDSLRulePlannerAccess().getAccessAssignment_5_2(), "rule__DSLRulePlanner__AccessAssignment_5_2");
			builder.put(grammarAccess.getDSLRulePlannerAccess().getShaltAssignment_5_4(), "rule__DSLRulePlanner__ShaltAssignment_5_4");
			...
			builder.put(grammarAccess.getDSLRuleExecutorAccess().getMonitorAssignment_0_4(), "rule__DSLRuleExecutor__MonitorAssignment_0_4");
			...
			builder.put(grammarAccess.getDSLRuleExecutorAccess().getAnalyzerAssignment_1_4(), "rule__DSLRuleExecutor__AnalyzerAssignment_1_4");
			...
			builder.put(grammarAccess.getDSLRuleExecutorAccess().getPlannerAssignment_2_4(), "rule__DSLRuleExecutor__PlannerAssignment_2_4");
			...
			builder.put(grammarAccess.getDSLRuleExecutorAccess().getExecutorAssignment_4_1(), "rule__DSLRuleExecutor__ExecutorAssignment_4_1");
			builder.put(grammarAccess.getDSLRuleExecutorAccess().getAccessAssignment_4_2(), "rule__DSLRuleExecutor__AccessAssignment_4_2");
			builder.put(grammarAccess.getDSLRuleExecutorAccess().getKnowledgeAssignment_4_4(), "rule__DSLRuleExecutor__KnowledgeAssignment_4_4");
			builder.put(grammarAccess.getDSLRuleExecutorAccess().getExecutorAssignment_5_1(), "rule__DSLRuleExecutor__ExecutorAssignment_5_1");
			builder.put(grammarAccess.getDSLRuleExecutorAccess().getAccessAssignment_5_2(), "rule__DSLRuleExecutor__AccessAssignment_5_2");
			builder.put(grammarAccess.getDSLRuleExecutorAccess().getEffectorAssignment_5_4(), "rule__DSLRuleExecutor__EffectorAssignment_5_4");
			builder.put(grammarAccess.getDSLRuleKnowledgeAccess().getKnowledgeAssignment_0_1(), "rule__DSLRuleKnowledge__KnowledgeAssignment_0_1");
			builder.put(grammarAccess.getDSLRuleKnowledgeAccess().getAccessAssignment_0_2(), "rule__DSLRuleKnowledge__AccessAssignment_0_2");
			builder.put(grammarAccess.getDSLRuleKnowledgeAccess().getMonitorAssignment_0_4(), "rule__DSLRuleKnowledge__MonitorAssignment_0_4");
			builder.put(grammarAccess.getDSLRuleKnowledgeAccess().getKnowledgeAssignment_1_1(), "rule__DSLRuleKnowledge__KnowledgeAssignment_1_1");
			builder.put(grammarAccess.getDSLRuleKnowledgeAccess().getAccessAssignment_1_2(), "rule__DSLRuleKnowledge__AccessAssignment_1_2");
			builder.put(grammarAccess.getDSLRuleKnowledgeAccess().getAnalyzerAssignment_1_4(), "rule__DSLRuleKnowledge__AnalyzerAssignment_1_4");
			builder.put(grammarAccess.getDSLRuleKnowledgeAccess().getKnowledgeAssignment_2_1(), "rule__DSLRuleKnowledge__KnowledgeAssignment_2_1");
			builder.put(grammarAccess.getDSLRuleKnowledgeAccess().getAccessAssignment_2_2(), "rule__DSLRuleKnowledge__AccessAssignment_2_2");
			builder.put(grammarAccess.getDSLRuleKnowledgeAccess().getPlannerAssignment_2_4(), "rule__DSLRuleKnowledge__PlannerAssignment_2_4");
			builder.put(grammarAccess.getDSLRuleKnowledgeAccess().getKnowledgeAssignment_3_1(), "rule__DSLRuleKnowledge__KnowledgeAssignment_3_1");
			builder.put(grammarAccess.getDSLRuleKnowledgeAccess().getAccessAssignment_3_2(), "rule__DSLRuleKnowledge__AccessAssignment_3_2");
			builder.put(grammarAccess.getDSLRuleKnowledgeAccess().getExecutorAssignment_3_4(), "rule__DSLRuleKnowledge__ExecutorAssignment_3_4");
			...
			builder.put(grammarAccess.getDSLSensorAccess().getLayerAssignment_2_0_2(), "rule__DSLSensor__LayerAssignment_2_0_2");
			builder.put(grammarAccess.getDSLSensorAccess().getSubSystemAssignment_2_1_2(), "rule__DSLSensor__SubSystemAssignment_2_1_2");
			builder.put(grammarAccess.getDSLEffectorAccess().getNameAssignment_1(), "rule__DSLEffector__NameAssignment_1");
			builder.put(grammarAccess.getDSLEffectorAccess().getLayerAssignment_2_0_2(), "rule__DSLEffector__LayerAssignment_2_0_2");
			builder.put(grammarAccess.getDSLEffectorAccess().getSubSystemAssignment_2_1_2(), "rule__DSLEffector__SubSystemAssignment_2_1_2");
			...
			builder.put(grammarAccess.getDSLMeasuredOutputAccess().getLayerAssignment_2_0_2(), "rule__DSLMeasuredOutput__LayerAssignment_2_0_2");
			builder.put(grammarAccess.getDSLMeasuredOutputAccess().getSubSystemAssignment_2_1_2(), "rule__DSLMeasuredOutput__SubSystemAssignment_2_1_2");
			builder.put(grammarAccess.getDSLAlternativeAccess().getNameAssignment_1(), "rule__DSLAlternative__NameAssignment_1");
			builder.put(grammarAccess.getDCLLayerAccess().getNameAssignment_1(), "rule__DCLLayer__NameAssignment_1");
			builder.put(grammarAccess.getDCLLayerAccess().getLevelAssignment_4(), "rule__DCLLayer__LevelAssignment_4");
			builder.put(grammarAccess.getDCLLayerAccess().getLayerAssignment_5_0_2(), "rule__DCLLayer__LayerAssignment_5_0_2");
			builder.put(grammarAccess.getDCLLayerAccess().getSubSystemAssignment_5_1_2(), "rule__DCLLayer__SubSystemAssignment_5_1_2");
			builder.put(grammarAccess.getDCLLayerAccess().getComponentAssignment_5_2_2(), "rule__DCLLayer__ComponentAssignment_5_2_2");
			builder.put(grammarAccess.getDCLComponentAccess().getNameAssignment_1(), "rule__DCLComponent__NameAssignment_1");
			builder.put(grammarAccess.getDCLComponentAccess().getLayerAssignment_2_0_2(), "rule__DCLComponent__LayerAssignment_2_0_2");
			builder.put(grammarAccess.getDCLComponentAccess().getSubSystemAssignment_2_1_2(), "rule__DCLComponent__SubSystemAssignment_2_1_2");
			builder.put(grammarAccess.getDCLComponentInterfaceAccess().getNameAssignment_1(), "rule__DCLComponentInterface__NameAssignment_1");
			builder.put(grammarAccess.getDCLComponentInterfaceAccess().getComponentAssignment_3(), "rule__DCLComponentInterface__ComponentAssignment_3");
			builder.put(grammarAccess.getDCLComponentInterfaceAccess().getInterfaceTypeAssignment_4_2(), "rule__DCLComponentInterface__InterfaceTypeAssignment_4_2");
			builder.put(grammarAccess.getInterfaceTypeAccess().getInterfaceTypeNameAssignment(), "rule__InterfaceType__InterfaceTypeNameAssignment");
			builder.put(grammarAccess.getDCLSubSystemAccess().getNameAssignment_1(), "rule__DCLSubSystem__NameAssignment_1");
			builder.put(grammarAccess.getDCLSubSystemAccess().getSubSystemAssignment_2_2(), "rule__DCLSubSystem__SubSystemAssignment_2_2");
			builder.put(grammarAccess.getDCLModuleAccess().getNameAssignment_1(), "rule__DCLModule__NameAssignment_1");
			builder.put(grammarAccess.getDCDeclAccess().getOnlyAssignment_0_0(), "rule__DCDecl__OnlyAssignment_0_0");
			builder.put(grammarAccess.getDCDeclAccess().getTAssignment_0_1(), "rule__DCDecl__TAssignment_0_1");
			builder.put(grammarAccess.getDCDeclAccess().getCanAssignment_0_2(), "rule__DCDecl__CanAssignment_0_2");
			builder.put(grammarAccess.getDCDeclAccess().getElementTypeAssignment_0_3(), "rule__DCDecl__ElementTypeAssignment_0_3");
			builder.put(grammarAccess.getDCDeclAccess().getTypeAssignment_0_4(), "rule__DCDecl__TypeAssignment_0_4");
			builder.put(grammarAccess.getDCDeclAccess().getTAssignment_1_0(), "rule__DCDecl__TAssignment_1_0");
			builder.put(grammarAccess.getDCDeclAccess().getCannotAssignment_1_1(), "rule__DCDecl__CannotAssignment_1_1");
			builder.put(grammarAccess.getDCDeclAccess().getElementTypeAssignment_1_2(), "rule__DCDecl__ElementTypeAssignment_1_2");
			builder.put(grammarAccess.getDCDeclAccess().getTypeAssignment_1_3(), "rule__DCDecl__TypeAssignment_1_3");
			builder.put(grammarAccess.getDCDeclAccess().getTAssignment_2_0(), "rule__DCDecl__TAssignment_2_0");
			builder.put(grammarAccess.getDCDeclAccess().getCanAssignment_2_1(), "rule__DCDecl__CanAssignment_2_1");
			builder.put(grammarAccess.getDCDeclAccess().getElementTypeAssignment_2_2(), "rule__DCDecl__ElementTypeAssignment_2_2");
			builder.put(grammarAccess.getDCDeclAccess().getTypeAssignment_2_3(), "rule__DCDecl__TypeAssignment_2_3");
			builder.put(grammarAccess.getDCDeclAccess().getTAssignment_3_0(), "rule__DCDecl__TAssignment_3_0");
			builder.put(grammarAccess.getDCDeclAccess().getCanAssignment_3_1(), "rule__DCDecl__CanAssignment_3_1");
			builder.put(grammarAccess.getDCDeclAccess().getElementTypeAssignment_3_2(), "rule__DCDecl__ElementTypeAssignment_3_2");
			builder.put(grammarAccess.getDCDeclAccess().getOnly2Assignment_3_3(), "rule__DCDecl__Only2Assignment_3_3");
			builder.put(grammarAccess.getDCDeclAccess().getTypeAssignment_3_4(), "rule__DCDecl__TypeAssignment_3_4");
			builder.put(grammarAccess.getDCDeclAccess().getTAssignment_4_0(), "rule__DCDecl__TAssignment_4_0");
			builder.put(grammarAccess.getDCDeclAccess().getMustAssignment_4_1(), "rule__DCDecl__MustAssignment_4_1");
			builder.put(grammarAccess.getDCDeclAccess().getEntityTypeAssignment_4_2(), "rule__DCDecl__EntityTypeAssignment_4_2");
			builder.put(grammarAccess.getDCDeclAccess().getTypeAssignment_4_3(), "rule__DCDecl__TypeAssignment_4_3");
