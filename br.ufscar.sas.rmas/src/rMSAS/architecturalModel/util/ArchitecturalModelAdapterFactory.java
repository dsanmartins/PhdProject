...
public class ArchitecturalModelAdapterFactory extends AdapterFactoryImpl {
	...
	protected ArchitecturalModelSwitch<Adapter> modelSwitch =
		new ArchitecturalModelSwitch<Adapter>() {
			@Override
			public Adapter caseArchitecturalRefactoring(ArchitecturalRefactoring object) {
				return createArchitecturalRefactoringAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link rMSAS.architecturalModel.ArchitecturalRefactoring <em>Architectural Refactoring</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createArchitecturalRefactoringAdapter() {
		return null;
	}
