...
public class ArchitecturalModelPackageImpl extends EPackageImpl implements ArchitecturalModelPackage {
	 ...
	 * @generated
	 */
	private EClass architecturalRefactoringEClass = null;
	 ...
	 */
	@Override
	public EClass getArchitecturalRefactoring() {
		return architecturalRefactoringEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getArchitecturalRefactoring_Name() {
		return (EAttribute)architecturalRefactoringEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getArchitecturalRefactoring_Smell() {
		return (EAttribute)architecturalRefactoringEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getArchitecturalRefactoring_Engine() {
		return (EAttribute)architecturalRefactoringEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getArchitecturalRefactoring_Description() {
		return (EAttribute)architecturalRefactoringEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EReference getArchitecturalRefactoring_ArchitecturalOperation() {
		return (EReference)architecturalRefactoringEClass.getEStructuralFeatures().get(4);
	}
	...
	public void createPackageContents() {
		...
		architecturalRefactoringEClass = createEClass(ARCHITECTURAL_REFACTORING);
		createEAttribute(architecturalRefactoringEClass, ARCHITECTURAL_REFACTORING__NAME);
		createEAttribute(architecturalRefactoringEClass, ARCHITECTURAL_REFACTORING__SMELL);
		createEAttribute(architecturalRefactoringEClass, ARCHITECTURAL_REFACTORING__ENGINE);
		createEAttribute(architecturalRefactoringEClass, ARCHITECTURAL_REFACTORING__DESCRIPTION);
		createEReference(architecturalRefactoringEClass, ARCHITECTURAL_REFACTORING__ARCHITECTURAL_OPERATION);
	...
	public void initializePackageContents() {
		...
		initEClass(architecturalRefactoringEClass, ArchitecturalRefactoring.class, "ArchitecturalRefactoring", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getArchitecturalRefactoring_Name(), ecorePackage.getEString(), "name", null, 0, 1, ArchitecturalRefactoring.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getArchitecturalRefactoring_Smell(), ecorePackage.getEString(), "smell", null, 0, 1, ArchitecturalRefactoring.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getArchitecturalRefactoring_Engine(), ecorePackage.getEString(), "engine", null, 0, 1, ArchitecturalRefactoring.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getArchitecturalRefactoring_Description(), ecorePackage.getEString(), "description", null, 0, 1, ArchitecturalRefactoring.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getArchitecturalRefactoring_ArchitecturalOperation(), this.getAbstractArchitecturalOperation(), null, "architecturalOperation", null, 1, -1, ArchitecturalRefactoring.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
