...
public class ArchitecturalModelFactoryImpl extends EFactoryImpl implements ArchitecturalModelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ArchitecturalModelPackage.ARCHITECTURAL_REFACTORING: return createArchitecturalRefactoring();
	 ...
	 */
	@Override
	public ArchitecturalRefactoring createArchitecturalRefactoring() {
		ArchitecturalRefactoringImpl architecturalRefactoring = new ArchitecturalRefactoringImpl();
		return architecturalRefactoring;
	}
